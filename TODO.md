...
| Path | Notes |
|------|-------|
| `chapter-5-domain-specific-language/` | Three prose files (`01-creating-our-own-language.md`, `02-a-simple-game.md`, `03-language-design.md`) — looks like an earlier draft of the CardLang/Compiler material (Ch 7/8). Not referenced anywhere. |
